...
#require 'auth.php'; // from the PHP-API-AUTH project, see: https://github.com/feliphegomez
...
#    exit(json_encode(array("error"=>'no_connect')));
#}
...
class PHP_CRUD_API {
	...
	protected function swagger($settings) {
		...
		echo '"info":{';
		echo '"title":"'.$database.'",';
		echo '"description":"API generated with https://github.com/feliphegomez/)",';
		echo '"version":"1.0.0"';
		echo '},';
